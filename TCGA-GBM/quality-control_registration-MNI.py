...
parser.add_argument("--modality_prefix", type=str, help="Directory where the data to collect is stored", default="TCGA-GBM-v1_MNI-ICBM-2009b-NLIN-ASYM")
...
parser.add_argument("--metadata", type=str, help="Name of the clinical data file", default="TCGA-GBM_clinical_v2.0.csv")
...
iso_levels = {
    "seg": [1,2,3,4],
    "flair": np.linspace(0, 650, 7),
    "t2": np.linspace(200, 1000, 5),
    "t1": np.linspace(0, 15000, 200),
    "t1ce": np.linspace(0, 15000, 150),
}
total_s = 0
