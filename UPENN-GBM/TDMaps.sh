...
CLINICAL_DATA_FILE="UPENN-GBM_clinical_info_v3.0.csv"
...
echo "ID,Gender,Age_at_scan_years,Survival_from_surgery_days_UPDATED,Survival_Status,MGMT,KPS,GTR_over90percent,${MORP_LABELS}" > $MORPHOLOGY
